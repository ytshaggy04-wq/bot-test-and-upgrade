...
⏱️ *𝗗ᴜʀᴀᴛɪᴏɴ* ➜ *${data.timestamp || 'N/A'}*
👀 *𝗩ɪᴇᴡꜱ* ➜ *${data.views?.toLocaleString() || 'N/A'}*
📅 *𝗣ᴜʙʟɪꜱʜᴇᴅ* ➜ *${data.ago || 'N/A'}*
🎤 *𝗖ʜᴀɴɴᴇʟ* ➜ *${data.author?.name || 'N/A'}*
...
✨ *𝗘𝘅𝗮𝗺𝗽𝗹𝗲*
`.schedule 94768069800 | Hello Bro | 30s`

👥 *𝗚𝗿𝗼𝘂𝗽 𝗘𝘅𝗮𝗺𝗽𝗹𝗲*
`.schedule 1203630...g.us | Meeting start! | 5m`
...
⚠️ *𝗡𝗼𝘁𝗲*
Use `|` *(pipe)* to separate each part.

*⚡ Powered by 𝗦𝗛𝗔𝗚𝗚𝗬-𝗫𝗠𝗗*
...
case 'setting': {
    ...
    if (!args.length) {
     ...
     ╭━━━〔 ⚙️ 𝗦𝗛𝗔𝗚𝗚𝗬-𝗫𝗠𝗗 𝗦𝗘𝗧𝗧𝗜𝗡𝗚𝗦 〕━━━╮

📝 *𝗨𝘀𝗮𝗴𝗲*
`.set KEY:VALUE`

✨ *𝗘𝘅𝗮𝗺𝗽𝗹𝗲*
`.set ALWAYS_ONLINE:true`

🫧 *𝗠𝘂𝗹𝘁𝗶 𝗦𝗲𝘁𝘁𝗶𝗻𝗴𝘀*
`.set ALWAYS_ONLINE:true,AUTO_RECORDING:true`

╭━━━〔 🔑 𝗦𝗬𝗦𝗧𝗘𝗠 𝗞𝗘𝗬𝗦 〕━━━╮
┃ 🟢 `ALWAYS_ONLINE` ➜ true/false
┃ 👁️ `ALWAYS_MSG_SEEN` ➜ true/false
┃ 🎙️ `AUTO_RECORDING` ➜ true/false
┃ ⌨️ `AUTO_TYPING` ➜ true/false
┃ 👀 `STATUS_VIEW` ➜ true/false
┃ ❤️ `AUTO_LIKE` ➜ true/false
┃ 🔣 `PREFIX` ➜ Custom prefix
┃ 🔐 `MODE` ➜ public/private
╰━━━━━━━━━━━━━━━━━━━━╯

💡 *𝗧ɪᴘ:* Use `,` to separate multiple settings.
